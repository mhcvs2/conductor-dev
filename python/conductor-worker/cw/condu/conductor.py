...
# This file was converted from a previous version that used python 2.7 created
# by Viren Baraiya - vbaraiya@netflix.com
# to python 3.6 using 2to3 and a few bugs fixed regarding the workflow versions
...
class WFClientMgr:
    def __init__(self, server_url='http://localhost:8080/api/'):
        self.workflow_client = WorkflowClient(server_url)
        self.task_client = TaskClient(server_url)
        self.metadata_client = MetadataClient(server_url)
