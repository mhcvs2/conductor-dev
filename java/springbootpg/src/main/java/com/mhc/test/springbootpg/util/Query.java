 ...
 */
package com.mhc.test.springbootpg.util;
...
public class Query implements AutoCloseable {
    ...
    protected final Query addParameterInternal(InternalParameterSetter setter) {
        ...
        try {
            ...
            throw new ApplicationException(ApplicationException.Code.BACKEND_ERROR, "Could not apply bind parameter at index " + index, ex);
        }
    }
